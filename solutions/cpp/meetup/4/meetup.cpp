...
namespace meetup {
    ...
    boost::gregorian::date scheduler::get_nth(boost::date_time::weekdays week_day, week_offset offset) const {
        size_t index = week_day;
        boost::gregorian::date::day_type::value_type m_offset = offset;
        return {this->year, this->month,
                static_cast<boost::gregorian::date::day_type::value_type>(first_week[index] + 7 * m_offset)};
    }
