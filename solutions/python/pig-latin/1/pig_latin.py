    ...
    for i in range(len(words)):
        ...
        if first_vowel_index != 0:
            ...
            if words[i].find('xr') == 0 or words[i].find('yt') == 0:
                ...
                # rule 4
                if y_index > 0:
                    words[i] = words[i][y_index:] + words[i][:y_index]
                # rule 3
                elif first_vowel_index > 0 and first_vowel == 'u' and words[i][first_vowel_index - 1] == 'q':
                    words[i] = words[i][first_vowel_index + 1:] + words[i][:first_vowel_index + 1]
                # rule 2
                elif first_vowel_index > 0:
                    words[i] = words[i][first_vowel_index:] + words[i][:first_vowel_index]
